...
final class CursorProximityControllerTests: XCTestCase {
    ...
    func testTriggersOnceWhenEnteringZone() {
        ...
        XCTAssertFalse(controller.tick(mouseLocation: CGPoint(x: 720, y: 850), now: 1))
        XCTAssertFalse(controller.tick(mouseLocation: CGPoint(x: 820, y: 880), now: 2))
        XCTAssertTrue(controller.tick(mouseLocation: CGPoint(x: 720, y: 880), now: 3))
        XCTAssertFalse(controller.tick(mouseLocation: CGPoint(x: 721, y: 879), now: 4))
    ...
    func testCooldownBlocksFastReentry() {
        ...
        XCTAssertTrue(controller.tick(mouseLocation: CGPoint(x: 720, y: 880), now: 10))
        XCTAssertFalse(controller.tick(mouseLocation: CGPoint(x: 80, y: 500), now: 11))
        XCTAssertFalse(controller.tick(mouseLocation: CGPoint(x: 720, y: 880), now: 12))
        XCTAssertFalse(controller.tick(mouseLocation: CGPoint(x: 80, y: 500), now: 17))
        XCTAssertTrue(controller.tick(mouseLocation: CGPoint(x: 720, y: 880), now: 18.1))
    ...
    func testDisabledStateDoesNotTrigger() {
        ...
        XCTAssertFalse(controller.tick(mouseLocation: CGPoint(x: 720, y: 880), now: 1))
        XCTAssertEqual(triggerCount, 0)

        controller.isEnabled = true
        XCTAssertFalse(controller.tick(mouseLocation: CGPoint(x: 721, y: 879), now: 2))
        XCTAssertFalse(controller.tick(mouseLocation: CGPoint(x: 80, y: 500), now: 3))
        XCTAssertTrue(controller.tick(mouseLocation: CGPoint(x: 720, y: 880), now: 4))
        XCTAssertEqual(triggerCount, 1)
    }
    ...
    func testManualShowStartsCooldown() {
        ...
        XCTAssertFalse(controller.tick(mouseLocation: CGPoint(x: 720, y: 880), now: 11))
